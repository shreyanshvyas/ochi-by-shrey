...
function Footer() {
  return (
    <div data-scroll
    data-scroll-section
    data-scroll-speed="-.03" className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X_Condensed']">
        <div className="heading">
          <h1 className="text-[9vw] uppercase font-semibold leading-none -mb-10">
            Eye-
          </h1>
          <h1 className="text-[9vw] uppercase font-semibold leading-none -mb-10">
            Opening
      ...
      <div className="w-1/2 h-full ">
        <div className="heading mb-9 font-['Founders_Grotesk_X_Condensed'] ">
          <h1 className="text-[9vw] font-semibold uppercase leading-none">
            presentations
          </h1>
        </div>
